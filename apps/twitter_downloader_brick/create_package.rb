...
repo_gems = [
  ...
  'https://gdc-ms-ruby-packages.s3.amazonaws.com/gooddata_connectors_metadata/v0.0.9.zip',
  'https://gdc-ms-ruby-packages.s3.amazonaws.com/gooddata_connectors_downloader_twitter/v0.0.1.zip'
]
